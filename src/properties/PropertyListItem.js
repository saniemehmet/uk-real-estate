                    ...
                    <Col>
                        <Row>
                            <Col className="col-md-6">
                                ...
                                <Col className="col-md-8 text-muted small">{property.displayable_address} | {property.agent_postcode}</Col>
                        ...
                        <Row>
                            ...
                            <span><strong>State:</strong> {property.furnished_state}</span>
                                    
                            </Row>
                            <hr className="my-1"/>
                            <Card.Text className="col-md-8 ms-2 property-description">
                                <Row>{property.short_description}</Row>
                            </Card.Text>
